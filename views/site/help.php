    ...
    <div class="row_block-9">
        ...
        <div class="packages">
            ...
            <div class="packages_item package">
                ...
                <div class="package_desc">2 пакета травы, 75 таблеток мескалина, 5 упаковок кислоты, полсолонки кокаина и целое множество транквилизаторов всех сортов и расцветок, депресанты, а также текила, ром, ящик пива, пинта чистого эфира и 2 дюжины ампул амилнитрита</div>
